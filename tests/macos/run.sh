...
export TEST_EXTRA_VARS="test_mode=true homebrew_update=false install_google_chrome=false install_omnissa_horizon=false install_nvim_tools=false macos_set_login_shell=false run_desktop_customization=false replace_existing_dotfiles=true"
